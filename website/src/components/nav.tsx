...
export function Nav() {
  return (
    <header className="fixed inset-x-0 top-4 z-50 flex justify-center px-4">
      <nav className="flex w-full max-w-[1152px] items-center justify-between gap-4 rounded-xl border border-[#363739] bg-void-black/60 px-3 py-2 backdrop-blur-2xl">
        <a
          href="#top"
